...
from dataset_RGBDD import DatasetFromFolderEval, DatasetFromFolder
...
def get_eval_set(hr_dir, lr_dir,rgb_dir):
    return DatasetFromFolderEval(hr_dir,lr_dir,rgb_dir,
                             input_transform=input_transform(),
                             input_rgb_transform = input_rgb_transform(),
                             target_transform=target_transform())
