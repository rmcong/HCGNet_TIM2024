...
from dataset import DatasetFromFolderEval, DatasetFromFolder, DatasetFromFolderEvalMiddle
...
def get_eval_set(lr_dir,rgb_dir,upscale_factor):
    return DatasetFromFolderEval(lr_dir,rgb_dir,upscale_factor,
                             input_transform=input_transform(),
                             input_rgb_transform = input_rgb_transform(),
                             target_transform=target_transform())

def get_eval_set_middle(lr_dir,rgb_dir):
    return DatasetFromFolderEvalMiddle(lr_dir,rgb_dir,
                             input_transform=input_transform(),
                             input_rgb_transform = input_rgb_transform(),
                             target_transform=target_transform())
