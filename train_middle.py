...
parser.add_argument('--data_dir', type=str, default='./data/middle_patch_x8/')  
parser.add_argument('--data_augmentation', type=bool, default=True)
parser.add_argument('--hr_train_dataset', type=str, default='train_depth_hr_big/')
parser.add_argument('--rgb_train_dataset', type=str, default='train_color_hr_big/')
parser.add_argument('--train_dataset', type=str, default='train_depth_x8_big/')
...
def train(epoch):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        # print(input.shape, input_rgb.shape, target.shape)
